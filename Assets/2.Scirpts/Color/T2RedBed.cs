...
public class T2RedBed : MonoBehaviour
{
    ...
    public void OnClick() // 마우스 클릭시
    {
        ...
        {
            GameObject.Find("bed2_1").GetComponent<Renderer>().material.color = Color.red;
        }
        if (GameObject.Find("Target2").transform.Find("bed2_2").gameObject.activeSelf == true)
        {
            GameObject.Find("bed2_2").GetComponent<Renderer>().material.color = Color.red;
        }
        if (GameObject.Find("Target2").transform.Find("bed2_3").gameObject.activeSelf == true)
        {
            GameObject.Find("bed2_3").GetComponent<Renderer>().material.color = Color.red;
        }
