...
public class T1BlackChair: MonoBehaviour {
	...
	{		
		...
		{
			GameObject.Find ("chair1_1").GetComponent<Renderer> ().material.color = Color.black;
		}
		if (GameObject.Find ("Target1").transform.Find("chair1_2").gameObject.activeSelf == true)
		{
			GameObject.Find ("chair1_2").GetComponent<Renderer> ().material.color = Color.black;
		}
		if (GameObject.Find ("Target1").transform.Find("chair1_3").gameObject.activeSelf == true)
		{
			GameObject.Find ("chair1_3").GetComponent<Renderer> ().material.color = Color.black;
		}
	}
