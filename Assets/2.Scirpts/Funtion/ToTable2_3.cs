...
public class ToTable2_3 : MonoBehaviour
{
    ...
    public void OnMouseUp()
    {
        ...
        GameObject.Find("Target2").transform.Find("chair2_3").gameObject.SetActive(false);
        ...
        GameObject.Find("Target2").transform.Find("table2_3").gameObject.SetActive(true);
